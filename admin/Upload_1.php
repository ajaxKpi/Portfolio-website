...
{
    global $file_path;
    global $compressedTool;
    $raw_img_location = saveRawImage($file, $NamePS, 'jpg');
    return $raw_img_location && $compressedTool->compressAndResize($raw_img_location, $file_path . $NamePS);
}
...
$compressedTool = new ImageResize();
...
if (isset($_POST['CreateButton'])) {
    ...
    $file_path = "../img/stories/" . $ID . $_POST['ps_name'] . "/";
    ...
    //download and each stories to the server
...
//--------------------------re upload large preview--------------------------
    ...
    $filepath = "img/stories/" . $ID . $_POST['edit_ps_name'] . "/";
