                ...
                <div class="tab-pane active" id="home">
                    ...
                    <form action="Upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="namefield">
                            ...
                            <input type="text" id="ps_name" class="text_input" name="ps_name"
                                   placeholder="ex: Egor and Julia">
                        </div>
                        <br>
                        <div class="span5 col-md-5" id="sandbox-container">
                            <div class="input-group date">
                                <input type="text" class="form-control" name="data"><span class="input-group-addon"><i
                        ...
                        <textarea class='form-control' id='id_comments' name='descr'
                                  placeholder='Description of photosession...' spellcheck="true" rows="10" cols="50">
                                Paste english version here
                        </textarea>
                        <textarea class='form-control' id='id_comments_ru' name='descr_ru'
                                  placeholder='Description of photosession...' spellcheck="true" rows="10" cols="50">
                                Русcкую версию сюда
                        </textarea>
                        <br>
                        <div class="tablewrap">
                            ...
                            <h3>Add wedding specialists(en/ru)</h3>
                              <textarea class='form-control' id='subcontr' name='subcontr' spellcheck="true" rows="10"
                                        cols="50">

                             </textarea>
                            <textarea class='form-control' id='subcontr_ru' name='subcontr_ru' spellcheck="true"
                                      rows="10" cols="50">
                    ...
                    <form action="Upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="span5 col-md-5" id="sandbox-container">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" name="edit_date" id="editDate"><span
                        ...
                        <br>
                        <textarea class='form-control' id='edit_comments' name='edit_descr'
                                  placeholder='Description of photosession...' spellcheck="true" rows="10"
                                  cols="50"></textarea>
                        <textarea class='form-control' id='edit_comments_ru' name='edit_descr_ru'
                                  placeholder='Description of photosession...' spellcheck="true" rows="10"
                                  cols="50"></textarea>
                        ...
                        <table id="preview">
                         ...
                         <textarea class='form-control' id='edit_subcontr' name='edit_subcontr' spellcheck="true"
                                   rows="10" cols="50">

                         </textarea>
                            <textarea class='form-control' id='edit_subcontr_ru' name='edit_subcontr_ru'
                                      spellcheck="true" rows="10" cols="50">
                    ...
                    <form action="Upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="span5 col-md-5" id="sandbox-container">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control" name="delete_date" id="deleteDate"><span
                                    class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                            </div>
                        </div>
                        <br>
                        ...
                        <br>
                        <textarea class='form-control' id='delete_comments' name='delete_descr'
                                  placeholder='Description of photosession...' spellcheck="true" rows="10"
                                  cols="50"></textarea>
                ...
                <div class="tab-pane" id="settings">
                    ...
                    <div class="span5 col-md-5" id="sandbox-container">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control" name="Busydata" id="BusyDate"><span
                                class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                        </div>
                    </div>
                    <br>
                    <br>
                    <div class="namefield">
                        <input type="text" id="Event" name="ps_name" class="text_input"
                               placeholder="No event for this date">
                    </div>
                    <br>
                    <button id="busyCr" class="buttons">Reserve</button>
                    <span class="status_Add"></span>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="col_id"><input type="text" id="link_id" name="link_id" class="link_input"
                                                      placeholder="ID(ex. 1)"></td>
                            <td><input type="text" id="link_descr" name="link_descr" class="link_input"
                                       placeholder="This ID is free"></td>
                            <td>
                    ...
                    <form action="Upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="span5 col-md-5" id="sandbox-container">
                            <div class="input-group date">
                                ...
                                <input type="text" id="feed_date" class="form-control" name="feed_data"><span
                                    class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="namefield">
                            ...
                            <input type="text" id="feed_name" class="text_input" name="feed_name"
                                   placeholder="ex: Oksana Fieldman">
                        </div>
                        <br>
                                     ...
                                     <textarea class='form-control' id='feedback_ru' name='feedback_ru'
                                               placeholder='Description of photosession...' spellcheck="true" rows="10"
                                               cols="50">
                                        Отзыв рус
                                    </textarea>
                        ...
                        <div class="tablewrap">
                            ...
                            <tr>
                                <td><input type="submit" value="add FB" id="feedButton" class="buttons"
                                           name="feedButton"></td>
                                <td><input type="submit" value="delete FB" id="delfeedButton" class="buttons"
                                           name="delfeedButton"></td>
                            </tr>
                        </div>
